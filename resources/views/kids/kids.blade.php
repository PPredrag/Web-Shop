...
@section('content')
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url({{ asset('images/banner/kids.jpg')}});">
		<h2 class="l-text2 t-center" id="sivaBojaSlova">
			Dečija Kolekcija
		</h2>
		<p class="m-text13 t-center" id="sivaBojaSlova">
			Nova Dečija Kolekcija
		</p>
	</section>
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="{{ asset('images/kids/dp2.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="{{ asset('images/kids/dp3.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/kids/dp6.jpg') }}" alt="IMG-PRODUCT">
					...
					<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/kids/dp7.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/kids/dp8.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/kids/dp9.jpg') }}" alt="IMG-PRODUCT">
