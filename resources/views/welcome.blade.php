...
<div class="slick1">
<div class="item-slick1 item1-slick1" style="background-image: url({{asset('images/kopacke.jpg')}});">
...
<div class="item-slick1 item2-slick1" style="background-image: url({{asset('images/patike1Slider.jpg')}});">
    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
...
<div class="item-slick1 item3-slick1" style="background-image:url({{asset('images/patike2Slider.jpg')}});">
    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
