...
<div class="panel panel-success">
	...
	<div class="panel-heading text-center">
		Proizvodi na popustu/Ovaj odeljak mora imati <span class="red">TAČNO 3 SLIKE</span>
	</div>
	<div class="panel-heading text-center">
		Trenutno ima &nbsp <span class="red">{{ count($forSale)}}</span>&nbsp proizvoda za Proizvodi na popustu</span>
	</div>
