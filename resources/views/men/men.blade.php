				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="{{ asset('images/men/pm2.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="{{ asset('images/men/pm3.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/men/pm5.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/men/pm6.jpg') }}" alt="IMG-PRODUCT">
					...
					<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/men/pm7.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/men/pm8.jpg') }}" alt="IMG-PRODUCT">
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >
							...
							<div class="block2" id="border">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									<img src="{{ asset('images/men/pm9.jpg') }}" alt="IMG-PRODUCT">
