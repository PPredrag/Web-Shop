...
@section('content')
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url({{ asset('images/banner/men.jpg')}});">
		<h2 class="l-text2 t-center" id="sivaBojaSlova">
			Muška Kolekcija
		</h2>
		<p class="m-text13 t-center" id="sivaBojaSlova">
			Nova Muška Kolekcija
		</p>
	</section>
		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
				...
				<div class="leftbar p-r-20 p-r-0-sm" id="padingRight">
					...
					<div class="letterG">
						Muška Kolekcija / Pretraži
						</div>
					<div class="search-product pos-relative bo4 of-hidden">

						<input class="s-text7 size6 p-l-23 p-r-50" id="search-product" type="text" name="product" placeholder="Pretraži Kolekciju...">
			...
			<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
				...
				<div class="flex-sb-m flex-w p-b-35">
					...
					<span class="s-text5 p-t-10 p-b-10 " id="countShoes">
...
@section('footer')
<script>
	// Ajax to search ALL product by key SEARCH type
	$(document).ready(function(){
		...
		$.each(data,function(key,value){
			var element='<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" >'+
						...
						' </a>' +
						' <span class="block2-newprice m-text8 p-r-5"> '+value.price+' ,00 din</span> '+				 
						' </div> </div></div>  ';
